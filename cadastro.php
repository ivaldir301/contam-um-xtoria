...
if(isset($_POST["sub_but"])):
    ...
    if(empty($nome) or empty($senha)):
        ...
        if($senha == $conf_senha):
            ...
            $sql = "INSERT INTO usuarios (nome, email, login, privilegios, senha) VALUES ('{$nome}', '{$email}', '{$login}', '{$privi_user}', '{$senha}');";  // falta aplicar o sql statement correcto aqui para inserir usuario
